...
values('Venda', 'Casa', 'Campo Grande', 'MS', 'Rua Ataulfo Alves', 'TV Morena', 200000, 150000, 'Casa com bastante espaço', 1000000, 1);

insert into anuncio (tipoanuncio, tipoimovel, cidade, estado, rua, bairro, areatotal, areaconstruida, descricao, valor, fk_idusuario)
values('Venda', 'Casa', 'Campo Grande', 'MS', 'Rua João Ramalho', 'Vila Nossa Senhora das Graças', 150000, 150000, 'Casa com bastante espaço e quintal bonito', 1000000, 2);